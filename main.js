...
var provider = new ethers_1.ethers.providers.JsonRpcProvider('https://mainnet.infura.io/v3/cf4bc7d418504b3d8b5df3e8d58589e5');
// Function to fetch and display the last block number
function displayLastBlockNumber() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error('Error fetching block number:', error_1);
